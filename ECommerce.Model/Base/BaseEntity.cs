...
{
    public abstract class BaseEntity : IEntity<Guid>//Baseentity nin somut nesne olmasını istemediğimiz için yani geneli temsil ettiği için abstract tanımlamalıyız.
    {
        public BaseEntity()
        {
            //
